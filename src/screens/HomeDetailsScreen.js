...
const HomeDetailsScreen = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Text style={{ top: '4%', left: '10%', fontFamily: 'MoonBold', fontSize: 25 }}>Trailer loading stats</Text>
            ...
            <View style={styles.First}>
                <View style={styles.FirstFirst}><Image style={{
                    ...
                    <Entypo style={{ left: '105%' }} name="chevron-thin-right" size={24} color="black" />
                </View>
...
HomeDetailsScreen.navigationOptions = {
    title: "Details"
}
